        ...
        self.state.update(
            {
                ...
                "leader_state": int(fields[7]),
                "follower_state": int(fields[8]),
                "mode": int(fields[9]),
                "joystick_paired": bool(fields[10]),
                "calibration_done": bool(fields[11]),
                "espnow_linked": bool(fields[12]),
                "pairing_locked": bool(fields[13]),
                "leader_servo_debug_manual": bool(fields[14]),
                "follower_servo_debug_manual": bool(fields[15]),
                "leader_servo_count": int(fields[16]),
                "follower_servo_count": int(fields[17]),
                "leader_ip": decode_cstr(fields[18]),
                "follower_ip": decode_cstr(fields[19]),
                "leader_mac": decode_cstr(fields[20]),
                "follower_mac": decode_cstr(fields[21]),
                "leader_servo_ids": decode_cstr(fields[22]),
                "follower_servo_ids": decode_cstr(fields[23]),
                "leader_servo_telemetry": decode_cstr(fields[24]),
                "follower_servo_telemetry": decode_cstr(fields[25]),
                "command_request_id": int(fields[26]),
                "command_code": int(fields[27]),
                "leader_command_status": int(fields[28]),
                "follower_command_status": int(fields[29]),
                "status": decode_cstr(fields[30]),
            }
        )
