        ...
        self.state.update(
            {
                ...
                "leader_servo_temperature_alarm": bool(fields[18]),
                "follower_servo_temperature_alarm": bool(fields[19]),
                "leader_servo_count": int(fields[20]),
                "follower_servo_count": int(fields[21]),
                "leader_ip": decode_cstr(fields[22]),
                "follower_ip": decode_cstr(fields[23]),
                "leader_mac": decode_cstr(fields[24]),
                "follower_mac": decode_cstr(fields[25]),
                "leader_servo_ids": decode_cstr(fields[26]),
                "follower_servo_ids": decode_cstr(fields[27]),
                "leader_servo_telemetry": decode_cstr(fields[28]),
                "follower_servo_telemetry": decode_cstr(fields[29]),
                "command_request_id": int(fields[30]),
                "command_code": int(fields[31]),
                "leader_command_status": int(fields[32]),
                "follower_command_status": int(fields[33]),
                "status": decode_cstr(fields[34]),
            }
        )
