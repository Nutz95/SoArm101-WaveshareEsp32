        ...
        self.state.update(
            {
                ...
                "leader_state": int(fields[15]),
                "follower_state": int(fields[16]),
                "mode": int(fields[17]),
                "joystick_paired": bool(fields[18]),
                "calibration_done": bool(fields[19]),
                "espnow_linked": bool(fields[20]),
                "pairing_locked": bool(fields[21]),
                "leader_servo_debug_manual": bool(fields[22]),
                "follower_servo_debug_manual": bool(fields[23]),
                "leader_servo_temperature_alarm": bool(fields[24]),
                "follower_servo_temperature_alarm": bool(fields[25]),
                "leader_servo_count": int(fields[26]),
                "follower_servo_count": int(fields[27]),
                "leader_ip": decode_cstr(fields[28]),
                "follower_ip": decode_cstr(fields[29]),
                "leader_mac": decode_cstr(fields[30]),
                "follower_mac": decode_cstr(fields[31]),
                "leader_servo_ids": decode_cstr(fields[32]),
                "follower_servo_ids": decode_cstr(fields[33]),
                "leader_servo_telemetry": decode_cstr(fields[34]),
                "follower_servo_telemetry": decode_cstr(fields[35]),
                "command_request_id": int(fields[36]),
                "command_code": int(fields[37]),
                "leader_command_status": int(fields[38]),
                "follower_command_status": int(fields[39]),
                "status": decode_cstr(fields[40]),
            }
        )
