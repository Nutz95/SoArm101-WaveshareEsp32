        ...
        self.state.update(
            {
                ...
                "leader_servo_debug_manual": bool(fields[12]),
                "follower_servo_debug_manual": bool(fields[13]),
                "leader_servo_count": int(fields[14]),
                "follower_servo_count": int(fields[15]),
                "leader_ip": decode_cstr(fields[16]),
                "follower_ip": decode_cstr(fields[17]),
                "leader_mac": decode_cstr(fields[18]),
                "follower_mac": decode_cstr(fields[19]),
                "leader_servo_ids": decode_cstr(fields[20]),
