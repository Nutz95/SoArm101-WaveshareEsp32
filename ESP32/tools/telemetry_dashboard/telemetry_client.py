        ...
        self.state.update(
            {
                ...
                "xbox_trigger_left": int(fields[23]),
                "xbox_trigger_right": int(fields[24]),
                "leader_state": int(fields[25]),
                "follower_state": int(fields[26]),
                "mode": int(fields[27]),
                "xbox_link_encrypted": bool(fields[28]),
                "xbox_input_subscribed": bool(fields[29]),
                "joystick_paired": bool(fields[30]),
                "xbox_controller_paired": bool(fields[31]),
                "calibration_done": bool(fields[32]),
                "espnow_linked": bool(fields[33]),
                "pairing_locked": bool(fields[34]),
                "leader_servo_debug_manual": bool(fields[35]),
                "follower_servo_debug_manual": bool(fields[36]),
                "leader_servo_temperature_alarm": bool(fields[37]),
                "follower_servo_temperature_alarm": bool(fields[38]),
                "leader_servo_count": int(fields[39]),
                "follower_servo_count": int(fields[40]),
                "leader_ip": decode_cstr(fields[41]),
                "follower_ip": decode_cstr(fields[42]),
                "leader_mac": decode_cstr(fields[43]),
                "follower_mac": decode_cstr(fields[44]),
                "leader_servo_ids": decode_cstr(fields[45]),
                "follower_servo_ids": decode_cstr(fields[46]),
                "leader_servo_telemetry": decode_cstr(fields[47]),
                "follower_servo_telemetry": decode_cstr(fields[48]),
                "xbox_controller_name": decode_cstr(fields[49]),
                "command_request_id": int(fields[50]),
                "command_code": int(fields[51]),
                "leader_command_status": int(fields[52]),
                "follower_command_status": int(fields[53]),
                "status": decode_cstr(fields[54]),
            }
        )
